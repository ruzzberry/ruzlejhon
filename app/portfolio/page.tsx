...
export default function Home() {
  ...
  return (
    <>
      <main
        className="min-h-screen p-6 md:pt-12 md:pb-20 md:px-24 relative animate-fade-in overflow-x-hidden"
        style={{
      ...
      >
          ...
          <div className="w-full md:col-span-8 space-y-6 text-left">
            ...
            <div className="max-w-xl space-y-4">
              <p className="text-lg opacity-90 leading-relaxed">
                I’m a full-stack web developer and QA engineer who enjoys
                building robust web solutions and making sure they actually work
                through manual and automated testing. From front-end to
                back-end, and from testing to deployment, I focus on great user
            ...
            <div className="flex flex-wrap items-center gap-3 md:gap-4 pt-4">
              <div className="flex flex-wrap gap-3 w-full sm:w-auto">
                <a
                  ...
                  className="border-4 border-[var(--foreground)] shadow-[8px_8px_0px_0px_var(--shadow)] bg-[black] text-white font-black uppercase text-base p-2 flex items-center gap-2 flex-1 sm:flex-none justify-center hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_var(--shadow)] transition-all text-black"
                >
                ...
                <a
                  ...
                  className="border-4 border-[var(--foreground)] shadow-[8px_8px_0px_0px_var(--shadow)] bg-[#facc15] text-black font-black uppercase text-base p-2 flex items-center gap-2 flex-1 sm:flex-none justify-center hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_var(--shadow)] transition-all text-black"
                >
                  <img src={"download.png"} className="w-5 h-5" alt="resume" />
                  DOWNLOAD CV
                </a>
              </div>
            </div>
        ...
        <Projects />
        <div className="h-[9vh]" /> {/*FOR GAP PURPOSE*/}
        <a className="border-4 border-[var(--foreground)] shadow-[8px_8px_0px_0px_var(--shadow)] bg-[#ff5c00] font-black uppercase text-xl md:text-3xl px-4 md:px-6 py-3 flex items-center gap-2 flex-1 sm:flex-none justify-center hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_var(--shadow)] transition-all text-black">
          CONTACT ME
        </a>
        <div className="h-[9vh]" /> {/*FOR GAP PURPOSE*/}
        <Contact />
